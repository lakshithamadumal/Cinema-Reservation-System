...
public class UpdateUser extends javax.swing.JFrame {
    ...
    public UpdateUser(String mobile, String name, String email, String password, String usertype) {
        initComponents();
        loadUserType();
    ...
    private void initComponents() {
        ...
        jPanel42.setLayout(new java.awt.GridLayout(4, 2, 7, 3));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (Mobile.isEmpty()) {
            ...
            try {
                ...
                ResultSet resultSet = mySQL.executeSearch("SELECT * FROM `user` WHERE `email` = '" + Email + "' AND `employee_mobile` = '" + Mobile + "' AND `password`='" + Password + "'");
                ...
                if (resultSet.next()) {
                    ...
                    mySQL.executeIUD("UPDATE `user` SET `password`='" + Password + "',`user_fname`='" + Name + "',`employee_mobile`='" + Mobile + "', `user_type_id`='" + usertypemap.get(Usertype) + "' WHERE `email`='" + Email + "'");
