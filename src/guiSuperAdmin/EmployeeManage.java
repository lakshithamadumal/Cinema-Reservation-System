...
import guiSuperAdmin.AddUser;
import guiSuperAdmin.UserRegistration;
 ...
 */
public class EmployeeManage extends javax.swing.JDialog {
     ...
     */
    public EmployeeManage(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
//        reload();
...
//    }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resource/printer (1).png"))); // NOI18N
...
//        }
        ...
        if (evt.getClickCount() == 2) { 
            ...
            AddUser adduser = new AddUser(mobile ,name,email);
            
            adduser.setVisible(true);
           
//            
//            AU.getjTextField5().setText(mobile);
//            AU.getjTextField6().setText(name);
//            AU.getjTextField7().setText(email);
          

            this.dispose();
//            UR.getjTextField6().grabFocus();
