 ...
 */
public class AddMovieGenres extends javax.swing.JDialog {

    /**
     * Creates new form AddEmployee
     */
    public AddMovieGenres(java.awt.Frame parent, boolean view) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String generes = jTextField1.getText();

        if (generes.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please Add Movie Genere", "Warning", JOptionPane.WARNING_MESSAGE);

        } else {
            try {

                ResultSet resultSet = mySQL.executeSearch("SELECT * FROM  `movie_category` WHERE `name`='" + generes + "'");
