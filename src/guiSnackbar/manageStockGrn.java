 ...
 */
public class manageStockGrn extends javax.swing.JDialog {

    snack_GRN grn;
    private static HashMap<String, String> brandMap = new HashMap<>();

    public manageStockGrn(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadProduct();
        loadStock();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            String product = String.valueOf(jTable1.getValueAt(row, 2));

            grn.getjTextField4().setText(id);
            grn.getjTextField4().setEnabled(false);
            grn.getjLabel6().setText(brand);
            grn.getjLabel3().setText(product);
            
            this.dispose();
            grn.getjDateChooser1().grabFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manageStockGrn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                manageStockGrn dialog = new manageStockGrn(new javax.swing.JFrame(), true);
